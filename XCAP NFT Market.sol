...
contract XMarket is CommonFunc {
    using SafeMath for uint256;
    ...
    event XTradeBegin(uint256 indexed tradeCode, address indexed from);

    event XTradeEnd(uint256 indexed tradeCode, address indexed from, address indexed to);
        ...
        payable
    {
        ...
        require(blackList[msg.sender] != XOriginNFT(_nftAddr).XIds(_tokenId));
        ...
        tradeList[tradeCodeCounter].XId = XOriginNFT(_nftAddr).XIds(_tokenId);
        ...
        emit XTradeBegin(tradeCodeCounter, msg.sender);
        ...
        public
    {
        ...
        emit XTradeEnd(_tradeCode, tradeList[_tradeCode].seller, msg.sender);
    }
